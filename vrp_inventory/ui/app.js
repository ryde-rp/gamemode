	...
	$.each(data, function(k, v) {
		if (v) {
			$('.quick-hotbar').find(`[data-utilitati-slot=${k}]`).html(`
                <img src="nui://vrp/gui/items/${v.name}.webp" onerror="this.src = 'https://cdn.discordapp.com/attachments/1102318566549762138/1113172602257678346/fi-xnluxx-question-mark-alt-removebg-preview.png'">
