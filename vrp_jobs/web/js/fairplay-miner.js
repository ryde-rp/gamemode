var minerDriver = new Vue({
    ...
    methods:{
        startminer: function() {
            this.Post("startMiner", {skill: this.selectedSkill});
            $(".miner-container").fadeOut();
        ...
        onKey() {
            ...
            if(theKey == "Escape") {
                $(".miner-container").fadeOut();
                $(".jobs-container").fadeOut();
                this.Post("CloseMiner", {close: true});
            }
        },
        SelectSkil(skil) {
        ...
        StopJob() {
            this.Post("job:quit", {job: "miner"});
            $(".miner-container").fadeOut();
            $(".jobs-container").fadeOut();
        },
        onMessage() {
            let data = event.data;
            if (data.action == "OpenMiner") {
                $(".miner-container").fadeIn();
