var fisherDriver = new Vue({
    ...
    methods:{
        startfisher: function() {
            this.Post("startFisher", {skill: this.selectedSkill});
            $(".fisher-container").fadeOut();
        ...
        onKey() {
            ...
            if(theKey == "Escape") {
                $(".fisher-container").fadeOut();
                $(".jobs-container").fadeOut();
                this.Post("CloseFisher", {close: true});
            }
        },
        SelectSkil(skil) {
        ...
        StopJob() {
            this.Post("job:quit", {job: "fisher"});
            $(".fisher-container").fadeOut();
            $(".jobs-container").fadeOut();
        },
        onMessage() {
            let data = event.data;
            if (data.action == "OpenFisher") {
                $(".fisher-container").fadeIn();
