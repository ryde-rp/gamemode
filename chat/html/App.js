...
window.APP = {
  ...
  methods: {
    ON_PAGESIZE_CHANGE ({size}){
      let msgBody = document.querySelector(".chat-messages");
      height = (70*size);
      msgBody.style = "height: "+height+"%;font-weight:"+fontweight+";";
    },
    ON_FONTSIZE_CHANGE ({size}){
      let msgBody = document.querySelector(".chat-messages");
      msgBody.style = "font-size: "+size+"px;height: "+height+"%;";
    },
...
function openPage(pageName, elmnt, evt) {
  ...
  elmnt.style.backgroundColor = "#c2505095";
