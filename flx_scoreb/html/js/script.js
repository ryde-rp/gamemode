...
$(document).ready(function() {
    window.addEventListener('message', (event) => {
        ...
        if (data.action == "updateScoreboard") {
            ...
            $('#onlinePlayers').html(data.onlinePlayers)
            $('#onlineStaff').html(data.onlineStaff)
            $('#onlinePolice').html(data.onlinePolice)
            $('#onlineEMS').html(data.onlineEMS)
            $('#onlineTaxi').html(data.onlineTaxi)
            $('onlineMechanics').html(data.onlineMechanics)
        }
