...
ExecApartment2 = {
    ...
    LoadDefault = function()
        ...
        ExecApartment2.Booze.Enable({ExecApartment2.Booze.A, ExecApartment2.Booze.B, ExecApartment2.Booze.C}, true)
        ExecApartment2.Smoke.Set(ExecApartment2.Smoke.stage2)
    end
}
