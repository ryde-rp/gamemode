...
GTAOApartmentHi2 = {
    ...
    LoadDefault = function()
        ...
        GTAOApartmentHi2.Booze.Enable({GTAOApartmentHi2.Booze.A, GTAOApartmentHi2.Booze.B, GTAOApartmentHi2.Booze.C}, true)
        GTAOApartmentHi2.Smoke.Enable({GTAOApartmentHi2.Smoke.A, GTAOApartmentHi2.Smoke.B, GTAOApartmentHi2.Smoke.C}, true)
