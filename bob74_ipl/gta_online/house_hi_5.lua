...
GTAOHouseHi5 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi5.Booze.Enable({GTAOHouseHi5.Booze.A, GTAOHouseHi5.Booze.B, GTAOHouseHi5.Booze.C}, true)
        GTAOHouseHi5.Smoke.Enable({GTAOHouseHi5.Smoke.A, GTAOHouseHi5.Smoke.B, GTAOHouseHi5.Smoke.C}, true)
