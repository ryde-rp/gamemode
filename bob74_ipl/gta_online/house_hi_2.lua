...
GTAOHouseHi2 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi2.Booze.Enable({GTAOHouseHi2.Booze.A, GTAOHouseHi2.Booze.B, GTAOHouseHi2.Booze.C}, true)
        GTAOHouseHi2.Smoke.Enable({GTAOHouseHi2.Smoke.A, GTAOHouseHi2.Smoke.B, GTAOHouseHi2.Smoke.C}, true)
