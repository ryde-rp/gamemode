...
GTAOHouseHi4 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi4.Booze.Enable({GTAOHouseHi4.Booze.A, GTAOHouseHi4.Booze.B, GTAOHouseHi4.Booze.C}, true)
        GTAOHouseHi4.Smoke.Enable({GTAOHouseHi4.Smoke.A, GTAOHouseHi4.Smoke.B, GTAOHouseHi4.Smoke.C}, true)
