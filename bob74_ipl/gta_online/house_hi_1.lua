...
GTAOHouseHi1 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi1.Booze.Enable({GTAOHouseHi1.Booze.A, GTAOHouseHi1.Booze.B, GTAOHouseHi1.Booze.C}, true)
        GTAOHouseHi1.Smoke.Enable({GTAOHouseHi1.Smoke.A, GTAOHouseHi1.Smoke.B, GTAOHouseHi1.Smoke.C}, true)
