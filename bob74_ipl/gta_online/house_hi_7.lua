...
GTAOHouseHi7 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi7.Booze.Enable({GTAOHouseHi7.Booze.A, GTAOHouseHi7.Booze.B, GTAOHouseHi7.Booze.C}, true)
        GTAOHouseHi7.Smoke.Enable({GTAOHouseHi7.Smoke.A, GTAOHouseHi7.Smoke.B, GTAOHouseHi7.Smoke.C}, true)
