...
GTAOApartmentHi1 = {
    ...
    LoadDefault = function()
        ...
        GTAOApartmentHi1.Booze.Enable({GTAOApartmentHi1.Booze.A, GTAOApartmentHi1.Booze.B, GTAOApartmentHi1.Booze.C}, true)
        GTAOApartmentHi1.Smoke.Enable({GTAOApartmentHi1.Smoke.A, GTAOApartmentHi1.Smoke.B, GTAOApartmentHi1.Smoke.C}, true)
