...
GTAOHouseHi6 = {
    ...
    LoadDefault = function()
        ...
        GTAOHouseHi6.Booze.Enable({GTAOHouseHi6.Booze.A, GTAOHouseHi6.Booze.B, GTAOHouseHi6.Booze.C}, true)
        GTAOHouseHi6.Smoke.Enable({GTAOHouseHi6.Smoke.A, GTAOHouseHi6.Smoke.B, GTAOHouseHi6.Smoke.C}, true)
