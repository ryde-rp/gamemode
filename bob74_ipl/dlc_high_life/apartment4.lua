...
HLApartment4 = {
    ...
    LoadDefault = function()
        ...
        HLApartment4.Booze.Enable({HLApartment4.Booze.A, HLApartment4.Booze.B, HLApartment4.Booze.C}, true)
        HLApartment4.Smoke.Enable({HLApartment4.Smoke.A, HLApartment4.Smoke.B, HLApartment4.Smoke.C}, true)
